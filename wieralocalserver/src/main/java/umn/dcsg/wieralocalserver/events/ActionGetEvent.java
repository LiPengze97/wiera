...
public class ActionGetEvent extends Event {
	private static final long serialVersionUID = 1L;
	//public Integer threshold = 0;

	public ActionGetEvent(LocalInstance instance, Response response) {
		super(instance, response);
	}

	public ActionGetEvent(LocalInstance instance, Map <String, Object> params, List lstResponse) {
