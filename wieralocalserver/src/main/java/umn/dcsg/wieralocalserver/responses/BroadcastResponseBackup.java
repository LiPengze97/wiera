 ...
 */
public class BroadcastResponseBackup extends Response {
    private List m_targetHostnameList = null;

    public BroadcastResponseBackup(LocalInstance instance, String strEventName, Map<String, Object> params) {
